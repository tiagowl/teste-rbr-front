...
export default function Home() {
  ...
  const [employee, setEmployee] = useState<null | Partial<Employee>>({name: "", role: "", department: ""});
  ...
  return (
    <Flex w="100%" minH="100vh" maxH="auto" >
      <Flex flexDirection="column" w="256px" minH="100vh" maxH="auto" bg="gray.900" >
        <Flex h="70px" px="5" cursor="pointer" onClick={()=>router.push("/")} alignItems="center" borderBottom="1px solid" borderBottomColor="gray.800" >
      ...
      <Flex w="100%" flexDirection="column" >
        ...
        <Flex w="100%" h="100%" bg="gray.50" p="32px" flexDirection="column" >
            <Heading size="md" >Adicionar Funcionário</Heading>
            ...
            <Flex px="2rem" flexDirection="column" py="5" w="100%" bg="white" minH="40vh" mt="3" maxH="auto" borderRadius="4px" >
                ...
                <Flex w="100%" justifyContent="flex-end" >
                    <Button bg="gray.900" onClick={()=> createEmployee()} color="white" fontSize="sm" >Adicionar</Button>
                </Flex>
            </Flex>
        </Flex>
      </Flex>
